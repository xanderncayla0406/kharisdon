...
const products: Product[] = [
  {
    ...
    description:
      "Made from grass-fed leaf fat — the most nutrient-dense part of the beef tallow. Cold-processed and whipped to perfection, stored in eco-friendly cobalt blue glass.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Local beeswax blended with pure honey and vanilla. A gentle, nourishing balm that speaks sweetness to your lips — naturally.",
    icon: (
      <svg viewBox="0 0 80 100" className="w-full h-full">
        <defs>
  ...
  },
  {
    ...
    description:
      "A rich, solid face oil crafted from local beeswax and nourishing oils. Melts into your skin, bringing deep restoration and radiant joy.",
    icon: (
      <svg viewBox="0 0 80 100" className="w-full h-full">
        <defs>
  ...
  },
  {
    ...
    description:
      "A gentle, oil-based cleanser that purifies without stripping. Cold-processed with locally sourced botanicals to cleanse and renew.",
    icon: (
      <svg viewBox="0 0 80 100" className="w-full h-full">
        <defs>
  ...
  },
  {
    ...
    description:
      "A refreshing mist that settles like morning dew. Made with all-natural botanicals to tone, balance, and revive your skin.",
    icon: (
      <svg viewBox="0 0 80 100" className="w-full h-full">
        <defs>
